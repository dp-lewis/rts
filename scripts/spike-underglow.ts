...
const SEEDS: EntitySeed[] = [
  ...
  { id: 3, kind: KIND.SCOUT, owner: 0, x: centre(8), y: centre(3) },
  { id: 4, kind: KIND.TANK, owner: 1, x: centre(9), y: centre(3) },
  { id: 5, kind: KIND.WORKER, owner: 0, x: centre(6), y: centre(5) },
  { id: 6, kind: KIND.SCOUT, owner: 1, x: centre(7), y: centre(5) },
  ...
  { id: 11, kind: KIND.SCOUT, owner: 0, x: centre(14), y: centre(4) },
  { id: 12, kind: KIND.SCOUT, owner: 0, x: centre(14), y: centre(4) },
